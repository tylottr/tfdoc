...
@click.command()
@click.option("-t", "--title", default="Terraform", help="The title in the generated document")
@click.option("-o", "--out-file", default=f"{os.getcwd()}/tfdoc_README.md",
...
def cli(tf_dir, title, out_file):
    ...
    with open(out_file, 'w') as f:
        data = generate_template(tf_dir, title)
        f.write(data)
